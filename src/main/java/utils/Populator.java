...
public class Populator {
    ...
    public static void populateWithInitialUsers(EntityManagerFactory emf) {
        try {
            ...
            User user = new User("user", "test123", 33, "user@user.dk");
            User admin = new User("admin", "test123", 44, "admin@admin.dk");
    ...
    public static void populateWithTestUsers() throws InvalidPasswordException, InvalidUsernameException, IllegalAgeException, UniqueException {
        ...
        User user = new User("user","1234",26, "user@user.dk");
        User admin = new User("admin","1234",26, "admin@user.dk");
        User userAdmin = new User("user_admin","1234",23, "ua@ua.dk");
        User noRole = new User("no_role","1234",36, "test@test.dk");
